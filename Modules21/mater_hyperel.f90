module mater_hyperel
  ...
  !    [11 22 33 12 23 13]
  ! F. Sjovall 2020-02-25
  !	 - Added option for axisymmetry in dneohooke 
  ! F. Sjovall 2020-02-28
  !  - Added option for axisymmetry in neohooke1up
  ! ------------------------------------------------------------------------------
  ...
  interface dneohooke
    ...
    !module procedure dneohookeaxisym
  end interface
  ...
  subroutine neohooke2(stype,stress,ef)
    ...
    if (size(ef).eq.4) then
      ...
      F(2,:)=(/ef(3), ef(4), 0d0/)
      F(3,:)=(/  0d0,   0d0, 1d0/)
    elseif (size(ef).eq.5) then    ! For axisymmetric elements
      F(1,:)=(/ef(1), ef(2), 0d0/)
      F(2,:)=(/ef(3), ef(4), 0d0/)
      F(3,:)=(/  0d0,   0d0, ef(5)/)	  
    else
    ...
    elseif (size(f).eq.5) then
      stress=(/S(1,1),S(2,2),S(1,2),S(3,3)/)
    else
  ...
  subroutine dneohooke2(stype,D,ef)
    ...
    elseif(size(ef).eq.5) then ! Added
  
      Ds(1) = a1*iC(1,1)*iC(1,1) - a2*(iC(1,1)+iC(1,1)) + a3*(iC(1,1)*iC(1,1)+iC(1,1)*iC(1,1))
      Ds(2) = a1*iC(1,1)*iC(2,2) - a2*(iC(2,2)+iC(1,1)) + a3*(iC(1,2)*iC(1,2)+iC(1,2)*iC(1,2))
      Ds(3) = a1*iC(1,1)*iC(1,2) - a2*(iC(1,2))         + a3*(iC(1,1)*iC(1,2)+iC(1,2)*iC(1,1))
      Ds(4) = a1*iC(1,1)*iC(3,3) - a2*(iC(3,3)+iC(1,1)) + a3*(iC(1,3)*iC(1,3)+iC(1,3)*iC(1,3))
  
      Ds(5) = a1*iC(2,2)*iC(2,2) - a2*(iC(2,2)+iC(2,2)) + a3*(iC(2,2)*iC(2,2)+iC(2,2)*iC(2,2))
      Ds(6) = a1*iC(1,2)*iC(2,2) - a2*(iC(1,2))         + a3*(iC(1,2)*iC(2,2)+iC(1,2)*iC(2,2))
      Ds(7) = a1*iC(2,2)*iC(3,3) - a2*(iC(3,3)+iC(2,2)) + a3*(iC(2,3)*iC(2,3)+iC(2,3)*iC(2,3))
      Ds(8) = a1*iC(1,2)*iC(1,2)												+ a3*(iC(1,1)*iC(2,2)+iC(1,2)*iC(2,1))
  
      Ds(9) = a1*iC(1,2)*iC(3,3) - a2*(iC(1,2))         + a3*(iC(1,3)*iC(2,3)+iC(1,3)*iC(2,3))
      Ds(10)= a1*iC(3,3)*iC(3,3) - a2*(iC(3,3)+iC(3,3)) + a3*(iC(3,3)*iC(3,3)+iC(3,3)*iC(3,3))
  
      D(1,:)=(/Ds(1), Ds(2), Ds(3), Ds(4)/)
      D(2,:)=(/Ds(2), Ds(5), Ds(6), Ds(7)/)
      D(3,:)=(/Ds(3), Ds(6), Ds(8), Ds(9)/)
      D(4,:)=(/Ds(4), Ds(7), Ds(9), Ds(10)/) 
  ...
  subroutine dfat2(GradFAT, ef,Targ, Aarg)
    ...
    double precision                :: tmp33(3,3),Test, gfun, GradFAT(6)
  !  character(len=*)               :: stype
