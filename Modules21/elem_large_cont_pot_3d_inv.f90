...
interface cp3dinv8p0_f
  module procedure cp3dinv8_f
end interface
...
subroutine cp3dinv8_e(ke,coord,duu,dup,dpu,dpp)
  implicit none
...
subroutine cp3dinv8_f(ef,coord,es,d)
  implicit none

  double precision                :: ef(:), coord(:,:), es(:,:), d(:,:)
