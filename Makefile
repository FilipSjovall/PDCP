...
CF77=ifort
CF90=ifort
F77FLAGS= -03 #-xHost #-mkl=parallel#
...
F90FLAGS = ${F77FLAGS} -w -m64 -fpp -I${SOLIDroot}
...
OBJS = run.o 
# Dependencies
DEPS = ${SOLIDroot}/mesh_reader.o ${SOLIDroot}/matrix_util.o 		\
	${SOLIDroot}/sparse_util.o ${SOLIDroot}/fem_util.o	${SOLIDroot}/memory_util.o ${SOLIDroot}/fem_system.o	\
	${SOLIDroot}/matlab_util.o ${SOLIDroot}/mater_large.o \
